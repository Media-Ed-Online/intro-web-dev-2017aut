...
In any way or place you choose, your site needs to include:
...
**The use of at least 2 attributes below:**<br />
You should be purposeful and deliberate in your text setting with the following properties:
- font-size:
- text-align:
- line-height: (Leading)
- letter-spacing: and/or word-spacing: (Kerning)
- font-variant: and/or text-transform:
- text-indent:
- text-decoration:

#### Color
<!--Refer back to the color palette you described in HW-04.

**This color palette should be used to color at least 2 of the instances below:**
1. the background
2. emphasized text
3. headings
4. headings background
...
**You can begin using color on your text,** but you needn't worry about the site as a whole. You will not be graded on site colors (like background and boxes) until HW-06 and "Layout". Experiment this week!
